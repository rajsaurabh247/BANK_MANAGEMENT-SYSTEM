...
class BANK_MANAGEMENT:
    def __init__(self):
            ...
            if self.accinfo.isdigit() == True and len(self.accinfo) != 0 and self.amtinfo.isdigit() == True and len(self.amtinfo) != 0 and int(self.amtinfo)!=0:
                ...
                if row is None:
                    ...
                    if ( r[7]-int(self.amtinfo) >= 0):
                        ...
                        messagebox.showinfo("SORRY!", "ENTER LESS AMOUNT")
        ...
        self.Button1.place(relx=0.39, rely=0.51, height=74, width=197)
        ...
        self.Message1.configure(text='''WITHDRAW AMOUNT...!!!''')
